            ...
            <div className="container">
                <div className="row without-bottom-margin">
                    <div className="col s6 push-s2">
                        <h5 className="without-top-margin">© Artyom Danilin</h5>
                    ...
                    <div className="col l4 offset-l2 s12 bottom-margin">
                        <h5 className="without-top-margin">Follow me:</h5>
                        <ul>
                            ...
                            <li><a className="animate_link" href="https://ru.linkedin.com/">Facebook</a></li>
                        </ul>
                    </div>
                </div>
            </div>
